...
export default function ExploreDashboard() {
  ...
  const dashboardViews = [
    {
      id: "dashboard",
      titleKey: "exploreDashboard.views.dashboard.title",
      subtitleKey: "exploreDashboard.views.dashboard.subtitle",
      image: "/images/Dashbaord.png",
      gradient: "from-emerald-500 to-teal-500"
    },
    {
      id: "developer",
      titleKey: "exploreDashboard.views.developer.title",
      subtitleKey: "exploreDashboard.views.developer.subtitle",
      image: "/images/Developer.png",
      gradient: "from-blue-500 to-cyan-500"
    },
    {
      id: "buyer",
      titleKey: "exploreDashboard.views.buyer.title",
      subtitleKey: "exploreDashboard.views.buyer.subtitle",
      image: "/images/Buyer.png",
      gradient: "from-purple-500 to-pink-500"
    },
    {
      id: "features",
      titleKey: "exploreDashboard.views.features.title",
      subtitleKey: "exploreDashboard.views.features.subtitle",
      ...
      <div className="relative mx-auto max-w-7xl px-4">
          ...
          <div className="relative aspect-video rounded-2xl md:rounded-3xl overflow-hidden bg-slate-900/50 backdrop-blur-xl border border-slate-700/50 shadow-2xl">
            ...
            {selectedView !== null && (
              <button
                ...
                className="absolute top-4 right-4 z-20 flex items-center gap-2 bg-slate-900/90 backdrop-blur-sm hover:bg-slate-800 text-white px-4 py-2 rounded-full transition-all duration-300 hover:scale-105 border border-slate-700/50 rtl:right-auto rtl:left-4"
              >
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M8 5v14l11-7z" />
                </svg>
                <span className="text-sm font-medium">{t('exploreDashboard.watchVideo')}</span>
              </button>
            )}
          </div>
        ...
        <div className="text-center px-4">
          ...
          >
            ...
            <span>{t('exploreDashboard.ctaButton')}</span>
            <ArrowRight className="w-5 h-5 md:w-6 md:h-6 group-hover:translate-x-2 transition-transform rtl:rotate-180" />
          </a>
          <p className="text-xs md:text-sm text-slate-400 mt-4 md:mt-5">
            {t('exploreDashboard.ctaSubtext')}
          </p>
        </div>
      </div>
    </section>
